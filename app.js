(() => {
  ...
  const translations = {
    sv: {
      heroEyebrow: 'Din AI-receptassistent', heroTitle: 'Vad ska vi laga?',
      ...
      whatDoYouHave: 'Vad har du hemma?', howPicky: 'Anpassa dina recept',
      ...
      freetextHint: 'Skriv fritt — Amko förstår vad du menar.',
      searchBtnHint: 'Lägg till minst en ingrediens för att söka',
      // Inspiration
      inspirationTitle: 'Inspiration',
      inspirationSub: 'Amkos bästa rekommendationer och världens kök — samlat åt dig',
      arminSub: 'Handplockade recept som alltid levererar. Testat och godkänt.',
      // Inköpslista
      ...
      // Auth
      authTitle: 'Ditt konto, dina recept',
      authDesc: 'Skapa ett konto för att synka favoriter, inköpslistor och recept mellan alla dina enheter.',
      ...
      authPrivacy: 'Vi värnar om din integritet. Ingen spam, inga nyhetsbrev — bara dina recept.',
      authBenefitSync: 'Favoriter och inställningar synkas automatiskt',
      authBenefitShop: 'Skicka inköpslistan direkt till din mejl',
      authBenefitReturn: 'Tillgång till dina recept var du än är',
      ...
      // Onboarding
      onboardingTitle: 'Välkommen till Amko',
      onboardingSub: 'Från ingredienser till färdig middag i tre enkla steg:',
      onboardingStep1Title: 'Berätta vad du har hemma',
      onboardingStep1Desc: 'Skriv in dina ingredienser eller fota kylskåpet — Amko identifierar råvarorna automatiskt.',
      onboardingStep2Title: 'Få 8 skräddarsydda recept',
      onboardingStep2Desc: 'Amko anpassar recepten efter dina ingredienser och önskemål — från snabba vardagsrätter till festmiddagar.',
      onboardingStep3Title: 'Laga, spara, handla',
      onboardingStep3Desc: 'Följ receptet steg-för-steg i kokläge, spara favoriter och skicka inköpslistan till din mejl.',
      onboardingCta: 'Kom igång',
      onboardingHint: 'Din AI-kock. Dina favoriter. Din inköpslista — allt synkat.',
      // Toast
      toastCopied: 'Kopierat till urklipp!',
      toastListSent: 'Inköpslistan har skickats till din mejl',
      toastListAdded: 'Ingredienser tillagda i inköpslistan',
      toastEmptyList: 'Listan är tom — lägg till ingredienser först',
      toastLoggedIn: 'Välkommen tillbaka!',
      toastLoggedOut: 'Du är nu utloggad',
      toastMagicSent: 'Vi har skickat en inloggningslänk till din mejl',
      toastError: 'Något gick fel. Vänligen försök igen.',
      ...
      toastBonAppetit: 'Smaklig måltid!',
      ...
      // Footer
      footerPanic: '\u00A9 2025 Vad ska vi laga?',
      footerAI: 'Villkor \u00B7 Integritet \u00B7 Kontakt',
      ...
      errorParseError: 'Receptsvaret var ofullständigt. Vänligen försök igen.',
      errorServer: 'Vi har tillfälliga serversvårigheter. Försök igen om en stund.',
      errorRateLimit: 'Du har gjort många sökningar. Vänta en minut och försök igen.',
      ...
      errorReload: 'Något gick fel. Försök ladda om sidan.',
      ...
      shareAppText: 'Testa Vad ska vi laga? — en AI-receptassistent som ger dig skräddarsydda recept utifrån dina ingredienser.',
      // Misc
      timeAgoNow: 'Nyss',
      timeAgoMin: 'min',
      timeAgoHour: 'tim',
      ...
      offlineMessage: 'Du verkar vara offline. Dina sparade favoriter finns tillgängliga medan du väntar på uppkoppling.',
    },
    en: {
      ...
      footerPanic: '\u00A9 2025 What should we cook?',
      footerAI: 'Terms \u00B7 Privacy \u00B7 Contact',
    ...
    es: {
      ...
      footerPanic: '\u00A9 2025 \u00BFQué vamos a cocinar?',
      footerAI: 'Términos \u00B7 Privacidad \u00B7 Contacto',
    ...
    bs: {
      ...
      footerPanic: '\u00A9 2025 Šta da kuhamo?',
      footerAI: 'Uslovi \u00B7 Privatnost \u00B7 Kontakt',
  ...
  const heroSubtitles = {
    sv: [
      'Berätta vad du har hemma. Amko ger dig recept på sekunder.',
      'Från ingredienser till färdig middag — snabbare än du tror.',
      'Snabbt, enkelt, gott. Anpassat efter vad du har hemma.',
      '8 recept på sekunder — anpassade efter dina ingredienser.',
      'Fota kylskåpet eller skriv in vad du har. Amko gör resten.',
      'Vardagsmat eller festmiddag — Amko har förslag för alla tillfällen.',
      'Slipp planeringen. Berätta vad du har, få recept direkt.',
      'Smartare matlagning börjar här.',
      'Dina ingredienser, Amkos recept. Perfekt matchning varje gång.',
      'Recept som passar det du redan har hemma.',
    ],
    en: [
  ...
  const footerTaglines = {
    sv: ['Smarta recept med AI — anpassade efter det du har hemma.', 'Din personliga receptassistent, alltid redo.', 'Från kylskåp till middag på rekordtid.', 'Amko gör matplaneringen enklare.', 'Recept som fungerar — varje gång.'],
    en: ['Smart recipes powered by AI — tailored to what you have at home.', 'Your personal recipe assistant, always ready.', 'From fridge to dinner in record time.', 'Amko makes meal planning effortless.', 'Recipes that work — every time.'],
    es: ['Recetas inteligentes con IA — adaptadas a lo que tienes en casa.', 'Tu asistente personal de recetas, siempre listo.', 'Del refrigerador a la cena en tiempo récord.'],
    bs: ['Pametni recepti s AI — prilagođeni onome što imaš kod kuće.', 'Tvoj lični asistent za recepte, uvijek spreman.', 'Od frižidera do večere u rekordnom vremenu.'],
  };
  ...
  const loadingMessages = {
    sv: ['Amko analyserar dina ingredienser...', 'Söker bland tusentals recept...', 'Matchar ingredienser med recept...', 'Anpassar recepten efter dina önskemål...', 'Beräknar portioner och näringsvärden...', 'Nästan klart — sista finslipningen...'],
    en: ['Amko is analyzing your ingredients...', 'Searching through thousands of recipes...', 'Matching ingredients with recipes...', 'Tailoring recipes to your preferences...', 'Almost there — final touches...'],
    es: ['Amko está analizando tus ingredientes...', 'Buscando entre miles de recetas...', 'Adaptando recetas a tus preferencias...', 'Casi listo — últimos ajustes...'],
    bs: ['Amko analizira tvoje sastojke...', 'Pretražuje hiljade recepata...', 'Prilagođava recepte tvojim preferencijama...', 'Skoro gotovo — posljednji detalji...'],
  };

  // ─── Toast messages (with variation) ───
  const toastVariations = {
    favAdded: {
      sv: ['Receptet har sparats bland dina favoriter.', 'Tillagd i favoriter!', 'Sparat — bra val.', 'Receptet finns nu bland dina favoriter.'],
    ...
    favRemoved: {
      sv: ['Borttagen från favoriter.', 'Receptet har tagits bort.', 'Borttagen — du kan alltid spara den igen.'],
